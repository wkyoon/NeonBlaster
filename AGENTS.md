...
#### 현재 기준선 (2026-08-08, 10게임·`BENCH_AI_ERROR=0.15`·난이도별 프로세스·해금 랭크)

| 난이도 | 랭크 | 동시 적 | 사망률 | 생존 | 학습 |
|---|---|---|---|---|---|
| EASY | 0 (+0%) | 3.1 | **0%** | 100% | 4.6단어/분 |
| NORMAL | 1 (+6%) | 3.7 | **20%** | 92% | 6.6단어/분 |
| HARD | 2 (+12%) | 4.4 | **50%** | 83% | 7.0단어/분 |

세 난이도 모두 목표 구간 안이다. 노브를 만졌다면 이 표를 갱신할 것.
