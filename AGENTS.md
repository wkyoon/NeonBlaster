...
|---|---|---|---|---|---|
| EASY | 첫날 | 10분 | **9.7분** (97%) | 3.4 ✗ | 100% |
| NORMAL | 5일차 | 15분 | **17.5분** (117%) | 3.0 ✗ | 100% |
| HARD | 20일차(상한) | 30분 | **33.0분** (110%) | 3.0 ✗ | 100% |

⚠️ **동시 적 수가 세 난이도 모두 하한(3.5)을 밑돈다 — 미해결이다.**
...
[`EnemySpawner._pick_enemy_type`](scripts/EnemySpawner.gd) 는 7종을 내보낸다(웨이브 8 이후 상한:
CHASER 15 / SHOOTER 25 / TANK 15 / DASHER 15 / BOMBER 12 / SPLITTER 10 / SHIELDER 8 %).
문제는 **비율이 아니라 수명**이었다.
